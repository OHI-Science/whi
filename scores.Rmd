...
Ocean Health Index scores are calculated for each region for each goal before being combined into an overall Index score for West Hawaiian Islands. 
...
regions <- bind_rows(
  data_frame(                
    region_id   = 0,
    region_name = 'West Hawaiian Islands'),
