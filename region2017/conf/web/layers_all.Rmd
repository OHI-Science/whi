...
```{r, echo=FALSE, results='hide'}
                                    ...
                                    download.file("https://raw.githubusercontent.com/OHI-Science/whi/master/region2017/conf/web/layers_all/fis_reef_catch.Rmd", x)
```
...
####[spp_ESA_status](https://github.com/OHI-Science/whi/tree/master/region2017/layers_whi/spp_ESA_status.csv) {-} 
```{r, echo=FALSE, results='hide'}
                                    ...
                                    download.file("https://raw.githubusercontent.com/OHI-Science/whi/master/region2017/conf/web/layers_all/spp_ESA_status.Rmd", x)
```
...
```{r, echo=FALSE, results='hide'}
                                    ...
                                    download.file("https://raw.githubusercontent.com/OHI-Science/whi/master/region2017/conf/web/layers_all/res_historical_sites.Rmd", x)
```
...
```{r, echo=FALSE, results='hide'}
                                    ...
                                    download.file("https://raw.githubusercontent.com/OHI-Science/whi/master/region2017/conf/web/layers_all/mar_risk.Rmd", x)
```
